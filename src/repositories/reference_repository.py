...
def update_reference(reference_id, reference_type, author=None, title=None, booktitle=None, 
                     year=None, url=None, doi=None, editor=None, volume=None, number=None, 
                     series=None, pages=None, address=None, month=None, 
                     organization=None, publisher=None, edition=None, 
                     howpublished=None, institution=None, journal=None, 
                     note=None, school=None, type=None):
    ...
    ref_type_id = get_reference_type_id(reference_type)
    sql = text('''UPDATE refs SET ref_type_id = :ref_type_id, author = :author, title = :title, 
